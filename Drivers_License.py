...
label_name_tag = canvas.create_text(37, 70, font=('Times', '12'), text="ID :")
label_dob_tag = canvas.create_text(50, 120, font=('Times', '12' ), text="D.O.B :")
label_pin_tag = canvas.create_text(65, 150, font=('Times', '12'), text="Pin Number :")
label_adress_tag = canvas.create_text(50, 180, font=('Times', '12'), text="Adress :")
label_authorization_tag = canvas.create_text(67, 210, font=('Times', '12'), text="Authorization :")
...
button1.configure(width=20, activebackground="#fcd408", relief=FLAT)
...
label_authorization_window = canvas.create_window(155, 252, anchor=CENTER, window=label_authorization)
canvas.pack()
